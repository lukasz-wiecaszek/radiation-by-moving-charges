...
This is a set of Python programs designed to simulate electromagnetic radiation
...
under the same name "Radiation By Moving Charges".
The article itself will/shall be available here once it is finished,
so please give me some time yet to finalize it.

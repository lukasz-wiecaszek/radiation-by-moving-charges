...
if args.animation:
    ...
    animation.save(
        f"charge-moving-with-constant-angular-velocity-s-field-{args.frequency:.2e}Hz.mp4",
        writer = mpla.FFMpegWriter(fps = fps))
else:
    plt.savefig(
        f"charge-moving-with-constant-angular-velocity-s-field-{args.frequency:.2e}Hz.png",

...
if args.quiver:
    ...
    quiver = ax.quiver(QX, QY, Ex, Ey, scale = 5e-6)
...
if args.animation:
    ...
    animation.save(
        f"oscillating-electric-dipole-e-field-{args.frequency:.2e}Hz.mp4",
        writer = mpla.FFMpegWriter(fps = fps))
else:
    plt.savefig(
        f"oscillating-electric-dipole-e-field-{args.frequency:.2e}Hz.png",
